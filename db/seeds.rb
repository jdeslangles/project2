...
u1 = User.create(first_name:'Britney Jo', last_name: 'Ludkowski', email: 'britneyjo.ludkowski@gmail.com', username: 'britjo', biography: 'Burgeoning web developer and houseplant assassin', location: 'Austin', role: 'admin', password:'password', password_confirmation:'password' )
